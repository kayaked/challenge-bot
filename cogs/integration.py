...
class accounts(commands.Cog):
    ...
    async def add_record(self, ctx):
        ...
        try:
            ...
            await ctx.author.send('What is the in-game name of the challenge? (case-sensitive)')
            ...
            if not (await db.levels.find_one({'name': level_name.content})):
